...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '2348135081678@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Fresh Hacker Bot MD,
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '234,1',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Fresh Hacker Bot MD",
    BOT_NAME: process.env.BOT_NAME || 'Fresh Hacker Bot MD',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭fresh¹¹ꫂ;Fresh Hacker MD bot : process.env.AUDIO_DATA,
